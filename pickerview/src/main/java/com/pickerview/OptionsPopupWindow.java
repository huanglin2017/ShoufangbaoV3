...
public class OptionsPopupWindow extends PopupWindow implements OnClickListener {
	...
	public void setPicker(ArrayList<String> optionsItems, int i, int j) {
		wheelOptions.setPicker(optionsItems, null, null, i, j, false);
	}

	public void setPicker(ArrayList<String> options1Items,
			ArrayList<ArrayList<String>> options2Items,int i, int j, boolean linkage) {
		wheelOptions.setPicker(options1Items, options2Items, null, i, j, linkage);
	}
	...
	public void setPicker(ArrayList<String> options1Items,
			...
			boolean linkage) {
		wheelOptions.setPicker(options1Items, options2Items, options3Items, i, j,
				linkage);
	}
	/**
	 * 设置选中的item位置
