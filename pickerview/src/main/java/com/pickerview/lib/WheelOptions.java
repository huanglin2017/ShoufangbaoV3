...
public class WheelOptions {
	...
	public void setPicker(ArrayList<String> optionsItems, int i, int j) {
		setPicker(optionsItems, null, null, i, j, false);
	}

	public void setPicker(ArrayList<String> options1Items,
			ArrayList<ArrayList<String>> options2Items,int i, int j, boolean linkage) {
		setPicker(options1Items, options2Items, null, i, j, linkage);
	}

	public void setPicker(ArrayList<String> options1Items,
			ArrayList<ArrayList<String>> options2Items,
			ArrayList<ArrayList<ArrayList<String>>> options3Items,int i, int j,
			boolean linkage) {
		...
		wv_option1.setCurrentItem(i);// 初始化时显示的数据

		// 选项2
		wv_option2 = (WheelView) view.findViewById(R.id.options2);
		if (mOptions2Items != null)
			wv_option2.setAdapter(new ArrayWheelAdapter(mOptions2Items.get(i)));// 设置显示数据
		wv_option2.setCurrentItem(j);// 初始化时显示的数据
