...
import com.kupangstudio.shoufangbao.widget.LockPatternView.Cell;
...
public class LockPatternUtils {
    ...
    private final static String KEY_LOCK_FIRSTPWD = "lock_firstpwd";
    ...
    public void saveFirstLockPattern(List<Cell> pattern){
        Editor editor = preference.edit();
        editor.putString(KEY_LOCK_FIRSTPWD, patternToString(pattern));
        editor.commit();
    }
    ...
    public String getFirstLockPaternString(){
        return preference.getString(KEY_LOCK_FIRSTPWD, "");
    }

    public int checkPattern(List<Cell> pattern) {
        String stored = getFirstLockPaternString();
        if(!stored.isEmpty()){
