...
public class PullUpLayout extends RelativeLayout
{
    ...
    Handler updateHandler = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            if (pullDownY < 0)
            {
                onReflushListener.isShow(false);
                // 已完成回弹
                pullDownY = 0;
    ...
    public void refreshFinish(int refreshResult)
    {
        isScroll = false;
        onReflushListener.isShow(false);
        //		AnimationDrawable animationDrawable = (AnimationDrawable) refreshingView.getBackground();
    ...
    private void changeState(int to)
    {
        ...
        switch (state)
        {
            case INIT:
                ...
                refreshStateTextView.setText(R.string.pull_to_refresh_my);
                pullView.clearAnimation();
            ...
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateTextView.setText(R.string.release_to_refresh_my);
            ...
            case REFRESHING:
                ...
                refreshStateTextView.setText(R.string.refreshing_my);
                break;
    ...
    public void setRefreshTime() {
        ...
        time_iv.setText(getResources().getString(R.string.xlistview_header_last_time)+str);
    }
    /**
     * 不限制上拉或下拉
     */
    ...
    private void initView()
    {
        ...
        time_iv = (TextView) refreshView.findViewById(R.id.time_iv1);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b)
    {
        if (!isLayout)
        {
            ...
            refreshDist = ((ViewGroup) refreshView).getChildAt(0)
                    .getMeasuredHeight();
            if(((ViewGroup) loadmoreView).getChildAt(0) != null){
    ...
    public interface OnRefreshListener
    {
         ...
         * 刷新操作
         */
        void onRefresh(PullUpLayout pullUpLayout);

        /**
         * 加载操作
         */
        void onLoadMore(PullUpLayout pullUpLayout);
    }
    ...
    public void setOnReflushListener(OnReflushListener onReListener){
        this.onReflushListener = onReListener;
    }
